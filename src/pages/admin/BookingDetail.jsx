  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ marginLeft: '260px', padding: '2rem', width: '100%' }}>
        ...
        <div style={{ background: '#fff', borderRadius: '10px', padding: '2rem', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', marginBottom: '2rem' }}>
        ...
        <div style={{ background: '#fff', borderRadius: '10px', padding: '2rem', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          ...
          <div>
            <p><strong>Base Price:</strong> PKR 1,000</p>
            <p><strong>Service Charge (10%):</strong> PKR 100</p>
            <p><strong>Tax (5%):</strong> PKR 60</p>
            <p><strong><u>Total Paid:</u></strong> PKR 1,160</p>
          </div>

          <div style={{ marginTop: '1rem' }}>
            <button style={{ marginRight: '1rem', padding: '8px 14px', border: 'none', background: '#DC2626', color: '#fff', borderRadius: '6px' }}>Cancel Booking</button>
            <button style={{ padding: '8px 14px', border: 'none', background: '#2563EB', color: '#fff', borderRadius: '6px' }}>Resend Invoice</button>
          </div>
        </div>
