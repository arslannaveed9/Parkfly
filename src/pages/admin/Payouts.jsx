...
const Payouts = () => {
  const actions = [
    { label: 'Mark as Paid', color: '#10B981', onClick: () => {} }
  ];
  ...
  <h1 style={{ fontSize: '1.75rem', marginBottom: '2rem' }}>Payout & Commission</h1>
        ...
        <div style={{ background: '#FFFFFF', padding: '1.5rem', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            ...
            <button style={{ background: '#0EA5E9', color: 'white', padding: '6px 10px', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>Export CSV</button>
          </div>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              <tr>
                ...
                <td style={tdStyle}>
                  <ActionButtons actions={actions} rowData={{ id: 'P1101' }} />
                </td>
              </tr>
              <tr>
