      ...
      <div style={{ marginLeft: '260px', padding: '2rem', width: '100%' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
            ...
            <div><strong>Commission (%):</strong> 10%</div>
          </div>
          ...
          <div style={{ marginTop: '2rem' }}>
            ...
            <button style={{ ...buttonStyle('#DC2626'), marginLeft: '1rem' }}>Reset Commission</button>
            <button style={{ ...buttonStyle('#0EA5E9'), marginLeft: '1rem' }}>Deactivate Lot</button>
          </div>
        </div>
      </div>
    </div>
